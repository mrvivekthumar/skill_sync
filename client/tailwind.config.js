...
const { reddit, dropbox1, padlet, scribd, weebly, razorpay } = yc100colors; // destructure all the yc100colors you want to use
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      //  all colured is derivwed from yc100compaonies color
